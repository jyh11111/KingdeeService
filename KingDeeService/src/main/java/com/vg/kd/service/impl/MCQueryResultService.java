...
import com.vg.kd.mapper.MCQueryResultMapper;
import com.vg.kd.service.IQueryService;
 
@Service("mcQueryResultService")
@DS("master")
public class MCQueryResultService extends ServiceImpl<MCQueryResultMapper, QueryResultEntity> implements IQueryService  {
