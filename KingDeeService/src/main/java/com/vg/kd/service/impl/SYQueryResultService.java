...
import com.vg.kd.mapper.SYQueryResultMapper;
import com.vg.kd.service.IQueryService;
 
@Service("syQueryResultService")
@DS("db1")
public class SYQueryResultService extends ServiceImpl<SYQueryResultMapper, QueryResultEntity> implements IQueryService  {
